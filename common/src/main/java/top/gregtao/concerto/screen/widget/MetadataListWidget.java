...
public class MetadataListWidget<T extends WithMetaData> extends ConcertoListWidget<T> {
    ...
    @Override
    protected void renderEntry(ConcertoListWidget<T>.Entry entry, GuiGraphicsExtractor graphics, int y, int x,
        ...
        graphics.text(this.minecraft.font, title, x, y + 3, this.color, false);
        if (!author.isEmpty()) {
            ...
            graphics.text(this.minecraft.font, Component.literal(visibleAuthor).withStyle(ChatFormatting.BOLD, ChatFormatting.GRAY),
