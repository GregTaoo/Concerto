...
public class CookieFile extends ConfigFile {
    ...
    public void write(CookieManager manager) {
        try {
            ...
            Concerto.getLogger().error("Error writing cookie", e);
        }
    }
    ...
    public void read(CookieManager manager) {
        try {
            ...
            Concerto.getLogger().error("Error reading cookie", e);
        }
    }
    ...
    public String readAsHeader() {
        try {
            ...
            Concerto.getLogger().error("Error reading cookie as header", e);
            return "";
        }
    }
}
