...
public class NeteaseCloudApiClient extends HttpApiClient {
    ...
    public FixedPlaylist getDailyRecommendation() {
         ...
         return new FixedPlaylist(musics, new PlaylistMetaData(Concerto.getMinecraft().getTranslatableText("concerto.source.netease_cloud"),
                 Concerto.getMinecraft().getTranslatableText("concerto.screen.daily_recommendation"), "", ""), false);
    }
