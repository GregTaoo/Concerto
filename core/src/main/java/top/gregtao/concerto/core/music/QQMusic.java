...
public class QQMusic extends Music implements CacheableMusic, DynamicPath {
    ...
    public MusicMetaData parseMetaData(JsonObject object) {
        ...
        return new BasicMusicMetaData(String.join(", ", singers), title, Sources.QQ_MUSIC.getName(), object.get("interval").getAsLong() * 1000, picUrl);
    }
    ...
    public void load() {
        try {
            ...
            this.setMusicMeta(new UnknownMusicMeta(Sources.QQ_MUSIC.getName()));
        }
        super.load();
    }
