...
public class QQMusicApiClient extends HttpApiClient {
    ...
    public Lyrics getLyric(String mid) throws Exception {
    ...
    public Pair<Integer, String> getQQLoginQRStatus() throws Exception {
        ...
        String result = this.get("https://ssl.ptlogin2.qq.com/ptqrlogin?u1=https%3A%2F%2Fgraph.qq.com%2Foauth2.0%2Flogin_jump&ptqrtoken=" + decryptQRSig(qrSig) + "&ptredirect=0&h=1&t=1&g=1&from_ui=1&ptlang=2052&action=0-1-" + getQQLoginTimestamp() + "&js_ver=23052315&js_type=1&login_sig=&pt_uistyle=40&aid=716027609&daid=383&pt_3rd_aid=100497308&&pt_js_version=v1.42.4").replace(" ", "");
