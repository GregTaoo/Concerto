...
public class KuGouMusicLoginScreen extends ConcertoScreen {
    ...
    protected void init() {
        super.init();
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 50, 40, 100, 20, new TranslatableText("concerto.screen.login.type.password"),
                button -> MinecraftClient.getInstance().setScreen(this.passwordLogin())
        ));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 50, 70, 100, 20, new TranslatableText("concerto.screen.login.type.captcha"),
                button -> MinecraftClient.getInstance().setScreen(this.captchaLogin())
        ));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 50, 100, 100, 20, new TranslatableText("concerto.screen.login.type.qrcode"),
                button -> MinecraftClient.getInstance().setScreen(this.qrCodeLogin())
        ));
        this.addDrawableChild(new ButtonWidget(this.width / 2 - 50, 130, 100, 20, new TranslatableText("concerto.screen.login.type.cookie"),
